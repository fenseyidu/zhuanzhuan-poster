...
- 4:3 and 16:9 long main titles include the semantic two-line title rule when applicable. For 2:1, follow the active route's measured width policy: 会员 A/S uses 908px at 1125px reference width and shrinks an over-width title while keeping one line; 会员 B uses 590px at the same reference width and semantically wraps an over-width title.
